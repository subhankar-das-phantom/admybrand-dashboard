...
const UsersPage = ({ users }: Props) => {
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="p-2 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 transition-colors duration-200">
  ...
  const UserRow = ({ user }: { user: any }) => (
    ...
    >
      ...
      <td className="px-6 py-4 text-gray-600">{user.totalOrders}</td>
  ...
  return (
    <Layout title="Users List | ADmyBRAND Dashboard">
      ...
      >
        {/* Header Section */}
        <motion.div variants={itemVariants} className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Manage and view all your users in one place</p>
            ...
            <div className="flex items-center space-x-3">
              <button className="bg-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-700 transition-colors duration-300 flex items-center space-x-2">
              ...
              <button className="bg-gray-100 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-colors duration-300 flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-4">
              ...
              {selectedUsers.length > 0 && (
                <div className="flex items-center space-x-2 bg-blue-50 px-4 py-2 rounded-xl">
                  <span className="text-sm text-blue-700">{selectedUsers.length} selected</span>
              ...
              <div className="flex items-center bg-gray-100 rounded-xl p-1">
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors duration-200 ${
                    filters.viewMode === 'grid' ? 'bg-white shadow-sm' : 'hover:bg-gray-200'
                  }`}
                >
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors duration-200 ${
                    filters.viewMode === 'list' ? 'bg-white shadow-sm' : 'hover:bg-gray-200'
                  }`}
                >
        ...
        {filteredUsers.length === 0 && (
          <motion.div variants={itemVariants} className="text-center py-16">
            ...
            <p className="text-gray-600 mb-8">Try adjusting your search criteria or add some users.</p>
